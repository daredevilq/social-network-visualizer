...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <LeftSidebar isOpen={isLeftSidebarOpen} selectedLeftSideBarContent={selectedLeftSideBarContent} />
      <SearchAndToggleModeContainer searchValue={searchQuery} onSearchChange={(value) => setSearchQuery(value)} />
      <GraphContainer />
      <RightSidebar />
    </div>
  );
