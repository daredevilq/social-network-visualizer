    ...
    <div className="bg-[#32323F] rounded-xl p-6 shadow-lg mb-8 w-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <MetricCard
          ...
          value={overview.avgSize.toFixed(2)}
        />
        <MetricCard label="max community size" value={overview.maxSize} />
        <MetricCard
          label="avg tweets / author"
          value={overview.avgTweetsPerAuthor.toFixed(2)}
        />
        <MetricCard
          label="avg hashtags / author"
          value={overview.avgHashtagsPerAuthor.toFixed(2)}
        />
        <MetricCard
          label="no. unique hashtags"
          value={overview.uniqueHashtags}
        />
