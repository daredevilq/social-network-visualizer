...
export function UsersMentionedContainer({
  userMentions,
  message,
}: UsersMentionedContainerProps) {
      ...
      {userMentions && userMentions.length > 0 ? (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {userMentions.map((user, index) => (
            ...
            >
              <div className="w-10 h-10 rounded-full bg-[#7140F4] flex items-center justify-center mb-2">
