            ...
            <div className="rounded-lg shadow-lg p-3 flex items-center justify-between space-x-3 h-10">
                ...
                <div className="w-32 flex flex-col items-center justify-center">
                    ...
                    >
                        <div className={`w-12 h-6 rounded-full transition duration-300 ${
                            isLabelsMode ? 'bg-[#7140F4]' : 'bg-gray-300'
                        } relative`}>
                            <span
                ...
                <div className="relative flex-grow">
                    ...
                    <input
                        ...
                        className="w-full h-9 pl-10 pr-4 py-2 text-gray-800 dark:text-black-200 placeholder-white-500 dark:placeholder-black-400 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-400 transition bg-[#FAFAFA]"
                    />
                </div>
            </div>
        </div>
