...
export default function ConfirmModal({ open, title, message, confirmLabel = 'OK', cancelLabel = 'Cancel', onCancel, onConfirm }: Props) {
  return (
    <Dialog open={open} onClose={onCancel} className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="bg-[#262631] rounded-xl shadow-xl w-[90%] max-w-sm p-6 space-y-6 z-50 relative" onClick={(e) => e.stopPropagation()}>
