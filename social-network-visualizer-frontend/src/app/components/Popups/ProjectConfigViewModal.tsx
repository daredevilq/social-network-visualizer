        ...
        const fetchConfig = async () => {
            ...
            try {
                const res = await fetch(
                    `${API_BASE_URL}/project/${encodeURIComponent(projectName)}/config`
                );
                if (!res.ok) {
                    throw new Error(
                ...
                const data = (await res.json()) as ProjectConfigDto;
                setConfig(data);
            } catch (err: any) {
                    ...
                    <div className="space-y-6">
                        <div className="bg-[#30303d] rounded-lg p-4 border border-gray-700">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="text-xs text-gray-400 mb-1 flex items-center gap-1 font-medium">
