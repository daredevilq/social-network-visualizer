...
export default function PopoverIcon(props: PopoverIconProps) {
  ...
  const arrowClasses = {
    ...
    bottom:
      "top-[-8px] left-1/2 -translate-x-1/2 border-x-8 border-x-transparent border-b-8 border-b-white",
    left: "right-[-8px] top-1/2 -translate-y-1/2 border-y-8 border-y-transparent border-l-8 border-l-white",
    right:
      "left-[-8px] top-1/2 -translate-y-1/2 border-y-8 border-y-transparent border-r-8 border-r-white",
  }[position];
