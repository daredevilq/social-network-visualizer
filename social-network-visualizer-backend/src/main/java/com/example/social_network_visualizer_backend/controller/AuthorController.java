...
public class AuthorController {
    ...
    public ResponseEntity<Map<String, Long>> getAuthorActivity(@PathVariable String authorName) {
        return ResponseEntity.ok(authorService.getUserActivity(authorName));
    }
    ...
    public ResponseEntity<List<String>> getMentionedUsers(@PathVariable String authorName) {
        return ResponseEntity.ok(authorService.findMentionsUsersByAuthor(authorName));
    }
    ...
    public ResponseEntity<List<String>> getRetweetsByUsers(@PathVariable String authorName) {
        return ResponseEntity.ok(authorService.findRetweetsByUser(authorName));
    }
