  ...
  @Query(
      """
          ...
          RETURN
              ...
              'AUTHOR' AS nodeType
          """)
  List<HashtagNodeDto> findTopAuthorsByHashtagId(@Param("hashtagName") String hashtagId);
  ...
  @Query(
      """
          ...
          RETURN
              ...
              'HASHTAG' AS nodeType
          """)
  List<HashtagNodeDto> findTopTweetsByHashtagId(@Param("hashtagName") String hashtagId);
}
