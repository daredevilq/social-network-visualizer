...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, String>> handleNoResourceFoundException(
    ...
    return ResponseEntity.status(HttpStatus.NOT_FOUND)
        .body(Map.of("error", "Requested URL not found"));
  }
  ...
  public ResponseEntity<Map<String, String>> handleDatabaseUnavailableException(
  ...
  public ResponseEntity<Map<String, String>> handleMethodNotSupported(
    ...
    return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
        .body(Map.of("error", "Method " + e.getMethod() + " is not supported for this endpoint."));
  }
  ...
  public ResponseEntity<Map<String, String>> handleTypeMismatch(
    ...
    log.error("\"Invalid value for parameter: {}", e.getMessage());
